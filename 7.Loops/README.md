...
Example code can be found in the [While Loop](https://github.com/upliftdev/Foundations/blob/main/Foundations/7.Loops/While_Loop) folder
...
Example code can be found in the [Incrementing](https://github.com/upliftdev/Foundations/blob/main/Foundations/7.Loops/Incrementing) folder
...
Example code can be found in the [For Loop](https://github.com/upliftdev/Foundations/blob/main/Foundations/7.Loops/For_Loop) folder
...
Example code can be found in the [Iterating Over Arrays and ArrayLists](https://github.com/upliftdev/Foundations/blob/main/Foundations/7.Loops/Iterating_Over_Arrays_and_ArrayLists) folder
...
Example code can be found in the [For Each Loop](https://github.com/upliftdev/Foundations/blob/main/Foundations/7.Loops/For_Each_Loop) folder
...
Project details can be found in the [Fizz Buzz Project](https://github.com/upliftdev/Foundations/blob/main/Foundations/7.Loops/Fizz_Buzz_Project) folder
...
Project details can be found in the [The Prime Directive Project](https://github.com/upliftdev/Foundations/blob/main/Foundations/7.Loops/The_Prime_Directive_Project) folder