...
Example code can be found in the [Intro to ArrayLists](https://github.com/upliftdev/Foundations/blob/main/Foundations/6.ArrayLists/Intro_to_ArrayLists) folder
...
Example code can be found in the [Creating ArrayLists](https://github.com/upliftdev/Foundations/blob/main/Foundations/5.Arrays%20and%20ArrayLists/Creating_ArrayLists) folder.
...
Example code can be found in the [Adding an Item](https://github.com/upliftdev/Foundations/blob/main/Foundations/6.ArrayLists/Adding_an_Item) folder.
...
Example code can be found in the [ArrayList Size](https://github.com/upliftdev/Foundations/blob/main/Foundations/6.ArrayLists/ArrayList_Size) folder
...
Example code can be found in the [Accessing an Index](https://github.com/upliftdev/Foundations/blob/main/Foundations/6.ArrayLists/Accessing_an_Index) folder.
...
Example code can be found in the [Changing a Value](https://github.com/upliftdev/Foundations/blob/main/Foundations/6.ArrayLists/Changing_a_Value) folder.
...
Example code can be found in the [Removing an Item](https://github.com/upliftdev/Foundations/blob/main/Foundations/6.ArrayLists/Removing_an_Item) folder
...
Example code can be found in the [Getting an Item's Index](https://github.com/upliftdev/Foundations/blob/main/Foundations/6.ArrayLists/Getting_an_Item_Index) folder
...
Project details can be found in the [Desert Island Playlist Project](https://github.com/upliftdev/Foundations/blob/main/Foundations/6.ArrayLists/Desert_Island_Playlist_Project) folder