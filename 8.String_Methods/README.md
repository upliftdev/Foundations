...
Example code can be found in the [length](https://github.com/upliftdev/Foundations/tree/main/8.String_Methods/length) folder
...
Example code can be found in the [concat](https://github.com/upliftdev/Foundations/tree/main/8.String_Methods/concat) folder
...
Example code can be found in the [equals](https://github.com/upliftdev/Foundations/tree/main/8.String_Methods/equals) folder
...
Example code can be found in the [indexOf](https://github.com/upliftdev/Foundations/tree/main/8.String_Methods/indexOf) folder
...
Example code can be found in the [charAt](https://github.com/upliftdev/Foundations/tree/main/8.String_Methods/charAt) folder
...
Example code can be found in the [substring](https://github.com/upliftdev/Foundations/tree/main/8.String_Methods/substring) folder
...
Example code can be found in the [toUpperCase and toLowerCase](https://github.com/upliftdev/Foundations/tree/main/8.String_Methods/toUpperCase_and_toLowerCase) folder
...
Project details can be found in the [DNA Sequencing Project](https://github.com/upliftdev/Foundations/tree/main/8.String_Methods/DNA_Sequencing_Project) folder