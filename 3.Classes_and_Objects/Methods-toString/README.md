...
Example code can be found in the [Store.java](https://github.com/upliftdev/Foundations/blob/main/Foundations/3.Classes_and_Objects/src/main/java/com/examples/classes13/Methods-toString/Store.java) file.
