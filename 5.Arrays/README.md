...
Example code can be found in the [Intro to Arrays](https://github.com/upliftdev/Foundations/blob/main/Foundations/5.Arrays/Intro_to_Arrays) folder
...
Example code can be found in the [Creating Arrays](https://github.com/upliftdev/Foundations/blob/main/Foundations/5.Arrays/Creating_Arrays) folder.
...
Example code can be found in the [Importing Arrays](https://github.com/upliftdev/Foundations/blob/main/Foundations/5.Arrays/Importing_Arrays) folder.
...
Example code can be found in the [Get Element By Index](https://github.com/upliftdev/Foundations/blob/main/Foundations/5.Arrays/Get_Element_By_Index) folder.
...
Example code can be found in the [Creating an Empty Array](https://github.com/upliftdev/Foundations/blob/main/Foundations/5.Arrays/Creating_an_Empty_Array) folder
...
Example code can be found in the [Array Length](https://github.com/upliftdev/Foundations/blob/main/Foundations/5.Arrays/Array_Length) folder.
...
Example code can be found in the [String Array Args](https://github.com/upliftdev/Foundations/blob/main/Foundations/5.Arrays/String_Array_Args) folder.
...
Example code can be found in the [Review Arrays](https://github.com/upliftdev/Foundations/blob/main/Foundations/5.Arrays/Review_Arrays) folder